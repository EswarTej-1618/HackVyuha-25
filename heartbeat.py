...
def send_whatsapp_message():
    phone_number = 'your phone number here'  # Replace with your phone number in international format
    ...
    sleep(40)  # Wait for WhatsApp to load
...
try:
    ...
    ser.reset_input_buffer()  # **Clears old Serial data**
...
def main():
    ...
    while True:
        try:
            ser.reset_input_buffer()  # **Ensures we only read fresh data**
            ...
            if "Heart Rate" in line:
                ...
                if match:
                    ...
                    # Ensure checks every 90 seconds
                    if time.time() - last_checked_time >= 90:
...
if __name__ == "__main__":
    speak("Heart Rate Monitoring System Initialized.")
